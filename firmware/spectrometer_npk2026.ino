...
// Wio Terminal Top Buttons (Active LOW)
...
#define BTN_WHITE WIO_5S_PRESS // จอยสติ๊กหน้าเครื่อง กดลงตรงกลาง -> เปิด/ปิด แสงขาว (White)
...
// ============================================================
// NPK Calibration Models (ผศ.ดร.ชีวะ ทัศนา)
// Reference: AI4D AGRIPHYSICS · RBRU
// Unit: mg/kg
// ============================================================
#define N_A0  -185.42f
#define N_A1    8.234f
...
void setup() {
  ...
  // 2. Initialize Top Buttons and Joystick Press with Pull-up
  ...
  if (SD.begin(SDCARD_SS_PIN, SDCARD_SPI)) {
    ...
    if (myFile) {
      myFile.println("Time,b,g,r,N,P,K");
      myFile.close();
    }
  } else {
  ...
  // 7. Draw Static Layout (Matching Photo Template)
  drawStaticLayout();
}
...
void drawStaticLayout() {
  ...
  tft.drawString("NPK Level Meter 1.02", 40, 36);
...
// ============================================================
void loop() {
  // 1. Handle Buttons A, B, C and 5-Way Joystick Center Press
