...
\begin{titlepage}
    ...
    {\fontsize{15}{20}\selectfont\color{agriGreen} หน่วยวิจัยฟิสิกส์เพื่อการเกษตรดิจิทัลและปัญญาประดิษฐ์ (AI4D AgriPhysics)\par}
...
% -------------------------------------------------------------
% สารบัญหลัก สารบัญภาพ สารบัญตาราง
% -------------------------------------------------------------
\tableofcontents
\newpage
\listoffigures
