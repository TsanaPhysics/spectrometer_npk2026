...
\midrule
1 & \texttt{[1/8]} & System Dashboard & ภาพรวมระบบ, แบรนด์ JC\_AI\_SciRBRU สี่สี, นาฬิกา RTC, สถานะเซนเซอร์ \\
2 & \texttt{[2/8]} & Dedicated Nitrogen & วิเคราะห์ไนโตรเจน (N), สลับไฟ \textbf{Blue 465 nm} อัตโนมัติ, ตัวอักษร N สี Magenta \\
3 & \texttt{[3/8]} & Dedicated Phosphorus & วิเคราะห์ฟอสฟอรัส (P), สลับไฟ \textbf{Red 625 nm} อัตโนมัติ, ตัวอักษร P สี Cyan \\
4 & \texttt{[4/8]} & Dedicated Potassium & วิเคราะห์โพแทสเซียม (K), สลับไฟ \textbf{Red 625 nm} อัตโนมัติ, ตัวอักษร K สี Red \\
5 & \texttt{[5/8]} & Soil pH Assay & ตรวจวัดกรด-ด่างดิน, สลับไฟคู่ \textbf{Green/Red 525/625 nm}, แถบสเกล 3.5--8.5 \\
...
8 & \texttt{[8/8]} & In-Situ Calib Wizard & วิเคราะห์การถดถอย OLS ($R^2, m, c,$ LOD, LOQ) บันทึกพารามิเตอร์ลง SD Card \\
\bottomrule
\end{tabularx}
\end{table}
...
จอยสติ๊กโยกขึ้น (\texttt{WIO\_5S\_UP}) & ด้านหน้า & หน้า Dashboard / NPK: สลับโหมดคำนวณ \textbf{[AI] $\to$ [PL] $\to$ [SC]} \\
