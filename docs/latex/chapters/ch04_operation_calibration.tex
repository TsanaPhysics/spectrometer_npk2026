...
\subsection{การวิเคราะห์สมบัติเชิงทัศนศาสตร์และความหนาแน่นของของเหลว (Page 5 หรือ Liquid Optics Metrology)}
...
\begin{itemize}
    \item กดโยกจอยสติ๊กตรงกลาง (\texttt{WIO\_5S\_PRESS}) เพื่อตั้งค่าศูนย์เทียบน้ำกลั่นบริสุทธิ์ (Pure Water Blank Reference หรือ $n = 1.3330$, $\rho = 0.9982\text{ g/cm}^3$)
