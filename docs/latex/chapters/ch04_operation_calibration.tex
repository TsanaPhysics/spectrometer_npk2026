...
ผู้ใช้งานสามารถควบคุมตัวเครื่องผ่านจอยสติ๊ก 5 ทิศทางและปุ่มกดด้านบนตัวเครื่อง โดยแบ่งออกเป็น 4 หน้าจอหลัก ดังแสดงในตารางที่ \ref{tab:controls_mapping}
...
จอยสติ๊กกดตรงกลาง (\texttt{WIO\_5S\_PRESS}) & ด้านหน้า & หน้าคาลิเบรต: สั่ง \textbf{Zero Blank ($I_0$)} ทุกช่องคลื่น \\
