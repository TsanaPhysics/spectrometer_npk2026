\section*{ภาคผนวก ก  ตารางค่าดัชนีหักเหและความหนาแน่นของสารละลายมาตรฐาน}
\addcontentsline{toc}{section}{ภาคผนวก ก  ตารางค่าดัชนีหักเหและความหนาแน่นของสารละลายมาตรฐาน}

ตารางที่ ก.1 แสดงค่าดัชนีหักเหของแสง (Refractive Index, $n$) และค่าความหนาแน่นของสารละลาย ($\rho$) ที่ระดับความเข้มข้นสารละลายของแข็งและน้ำตาลต่าง ๆ ($^\circ\text{Bx}$) ที่อุณหภูมิ 20 องศาเซลเซียส ตามมาตรฐานสากล ICUMSA และแบบจำลอง Lorentz-Lorenz
...
\vspace{0.8cm}
\section*{ภาคผนวก ข  ข้อมูลจำเพาะเชิงเทคนิคและสถาปัตยกรรมฮาร์ดแวร์ Wio Terminal}
\addcontentsline{toc}{section}{ภาคผนวก ข  ข้อมูลจำเพาะเชิงเทคนิคและสถาปัตยกรรมฮาร์ดแวร์ Wio Terminal}
